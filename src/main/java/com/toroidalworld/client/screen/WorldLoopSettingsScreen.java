...
public class WorldLoopSettingsScreen extends Screen {
    ...
    protected void init() {
        ...
        this.sizeEdit = new EditBox(this.font, FIELD_WIDTH, FIELD_HEIGHT, sizeLabel());
        this.sizeEdit.setMaxLength(FIELD_MAX_LENGTH);
        this.sizeEdit.setFilter(value -> value.isEmpty() || value.chars().allMatch(Character::isDigit));
        ...
        this.endSizeEdit = new EditBox(this.font, FIELD_WIDTH, FIELD_HEIGHT, endSizeLabel());
        this.endSizeEdit.setMaxLength(FIELD_MAX_LENGTH);
        this.endSizeEdit.setFilter(value -> value.isEmpty() || value.chars().allMatch(Character::isDigit));
