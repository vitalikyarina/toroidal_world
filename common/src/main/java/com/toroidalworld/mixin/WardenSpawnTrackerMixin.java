...
public class WardenSpawnTrackerMixin {
    ...
    private static boolean toroidal$warningRangeThroughSeam(Vec3 playerPosition, Position shriekerOrigin,
        ...
        return ReseatProbe.decided(player.level(), ReseatProbe.WARNING_RANGE,
                original.call(playerPosition, shriekerOrigin, distance),
                SeamRange.closerThan(player, playerPosition, shriekerOrigin, distance));
    }
}
