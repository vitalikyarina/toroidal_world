 ...
 *
 * <p>Entry points: {@link com.toroidalworld.api.v1.ToroidalWorldApi#shapeOf} for a server/logical-server level,
 * {@link com.toroidalworld.api.v1.ToroidalWorldClientApi#shapeOf} for the client level (bounds synced from the
 * server).</p>
 */
